...
import UPDATE_TASK from './UpdateTask';
...
import LOGIN_WITH_FACEBOOK from './LoginWithFacebook';

export default { REGISTER, NEW_TASK, UPDATE_TASK, REMOVE_TASK, ORDER_TASKS, TASK_DONE, TASK_UNDONE, DELETE_USER, SETUP_USER, FORGET_PASSWORD, RESET_PASSWORD, LOGIN_WITH_FACEBOOK };